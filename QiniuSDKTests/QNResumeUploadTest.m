...
- (void)setUp {
  ...
  NSString *travis =
      [[NSProcessInfo processInfo] environment][@"QINIU_TEST_ENV"];
...
- (void)testCancel {
  ...
  [_upManager putFile:tempFile.path
                  key:keyUp
                token:g_token
...
- (void) template:(int)size {
  ...
  __block NSString *key = nil;
  __block QNResponseInfo *info = nil;
  QNUploadOption *opt = [[QNUploadOption alloc]
...
- (void)templateHttps:(int)size {
  ...
  QNConfiguration *config =
      [QNConfiguration build:^(QNConfigurationBuilder *builder) {
        QNServiceAddress *s =
            [[QNServiceAddress alloc] init:@"https://uptemp.qbox.me" ips:nil];
  ...
  [upManager putFile:tempFile.path
                 key:keyUp
               token:g_token
            complete:^(QNResponseInfo *i, NSString *k, NSDictionary *resp) {
              key = k;
...
- (void)testNoKey {
  ...
  XCTAssert([@"FnwKMB9tve71u37IlABna6j4Gdyr" isEqualToString:testResp[@"key"]],
            @"Pass");
  [QNTempFile removeTempfile:tempFile];
}
...
- (void)testProxy {
  ...
  QNConfiguration *config =
      [QNConfiguration build:^(QNConfigurationBuilder *builder) {
        ...
        QNServiceAddress *s =
            [[QNServiceAddress alloc] init:@"http://upnono.qiniu.com" ips:nil];
        builder.zone = [[QNZone alloc] initWithUp:s upBackup:nil];
      }];
  ...
  QNConfiguration *config =
      [QNConfiguration build:^(QNConfigurationBuilder *builder) {
        builder.converter = ^NSString *(NSString *url) {
          return [url stringByReplacingOccurrencesOfString:@"upnono"
                                                withString:@"up"];
        };
        QNServiceAddress *s =
            [[QNServiceAddress alloc] init:@"http://upnono.qiniu.com" ips:nil];
...
- (void)testHosts {
  ...
  QNConfiguration *config =
      [QNConfiguration build:^(QNConfigurationBuilder *builder) {
        ...
        QNServiceAddress *s1 =
            [[QNServiceAddress alloc] init:@"http://uphosttest.qiniu.com"
                                       ips:ips];
        QNServiceAddress *s2 =
            [[QNServiceAddress alloc] init:@"http://uphosttestbak.qiniu.com"
                                       ips:ips];
  ...
  XCTAssert(info.isOK, @"Pass");
  XCTAssert([keyUp isEqualToString:key], @"Pass");
  XCTAssert([info.host isEqual:@"uphosttest.qiniu.com"] ||
                [info.host isEqual:@"uphosttestbak.qiniu.com"],
            @"Pass");
  [QNTempFile removeTempfile:tempFile];
}
